...
public class SistemaPersistencia {
	...
	public void eliminarRecorrido(String identificador) {
		base.eliminarRecorrido(identificador);
	}
	
	/**
	 * ambia la fecha y hora de un recorrido seleccionado por el indice de la lista
	...
	public void actualizarRecorrido (LocalDateTime fechaHora, String idRecorrido) {
		...
		Recorrido recorridoAlmacenado = base.getRecorrido(idRecorrido);
		...
		base.actualizarRecorrido(recorridoActualizado);
	}
	 ...
	 * @return recorrido El recorrido asociado a ese id
	 */
	public Recorrido getRecorrido(String idRecorrido) {
		return base.getRecorrido(idRecorrido);
	}
	...
	public List<Billete> getBilletesAsociados(String localizador){
		return base.getBilletes(localizador);
	}
	...
	public void comprarBillete(String localizador, Usuario usuario, Recorrido recorrido, int numBilletes){
		...
		for(int i = 0; i<numBilletes; i++) {
			base.addBillete(new Billete (localizador, usuario, recorrido, false));
	...
	public void devolverBillete(String localizador, int numBilletes){
		...
		ArrayList<Billete> listaBilletesLocalizador = base.getBilletes(localizador);
		...
		base.eliminarBilletes(localizador);
	...
	public void reservarBillete(String localizador, Usuario usuario, Recorrido recorrido, int nBilletes) {
		...
		for(int i=0; i<nBilletes; i++) {
			actualizarRecorridoMenosPlazas(recorrido.getIdentificador());
			base.addBillete(new Billete(localizador, usuario, recorrido, true));
		}
	}
	...
	public void anularReserva(String localizador, int nBilletes) {
		...
		base.eliminarBilletes(localizador);
		for (Billete billete : listaBilletesLocalizador) {
			actualizarRecorridoMasPlazas(billete.getRecorrido().getIdentificador());
			base.addBillete(billete);
		}
	...
	public double precioBilletesUsuario(String nif) {
		...
		ArrayList<Billete> listaBilletesUsuario = base.getBilletesDeUsuario(nif);
	...
	public List<Recorrido> recorridoFecha(LocalDate fecha){
		return base.getRecorridos(fecha);
	}
}
